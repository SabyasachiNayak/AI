...
@Controller
@RequestMapping("/flowerIdentification")
public class FlowerIdentificationController {

   @RequestMapping(value = "/", method = RequestMethod.GET)
   public String login(ModelMap model) {
	      return "flowerDashboard";
   } 
   ...
   public ResponseEntity<Flower> register(@RequestBody Flower flower)
   {
	   ...
	   String[] cmd = {
			      "python",
			      "C:\\AI\\ApartmentPricePrediction\\python\\flower_classification.py",
